...
RSS feed integration and Lovelace card for Home Assistant — one repository, one HACS install.

## Highlights

- Server-side RSS polling with sensor entities
- Lovelace card with compact, ticker, list, card, and magazine presets
- Visual Editor, RTL support, images, animations, NEW badge, read/unread tracking
- OPML import, optional notifications (off by default), manual refresh services
